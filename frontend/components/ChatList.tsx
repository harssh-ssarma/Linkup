  ...
  useEffect(() => {
    const mockChats: Record<string, Chat[]> = {
      personal: [
        {
          ...
          timestamp: '2m ago',
          unreadCount: 3,
          avatar: 'https://ui-avatars.com/api/?name=Priya+Patel&background=4F46E5&color=fff',
          isOnline: true,
          isGroup: false,
          isChannel: false,
          isPinned: true,
        ...
        },
        {
          ...
          timestamp: '1h ago',
          unreadCount: 0,
          avatar: 'https://ui-avatars.com/api/?name=Rahul+Gupta&background=059669&color=fff',
          isOnline: false,
          isGroup: false,
          isChannel: false,
          isPinned: false,
        ...
        },
        {
          ...
          timestamp: '3h ago',
          unreadCount: 1,
          avatar: 'https://ui-avatars.com/api/?name=Kavya+Reddy&background=DC2626&color=fff',
          isOnline: true,
          isGroup: false,
          isChannel: false,
          isPinned: false,
      ...
      groups: [
        {
          id: 'g1',
          name: 'Tech Team Delhi',
          lastMessage: 'Sneha: Great work everyone! 🎉',
          timestamp: '30m ago',
          unreadCount: 5,
          avatar: 'https://ui-avatars.com/api/?name=Tech+Team+Delhi&background=7C3AED&color=fff',
          isOnline: true,
          isGroup: true,
          isChannel: false,
          isPinned: true,
        ...
        },
        {
          id: 'g2',
          name: 'Sharma Family',
          lastMessage: 'Mummy: Dinner at 7 PM today',
          timestamp: '2h ago',
          unreadCount: 2,
          avatar: 'https://ui-avatars.com/api/?name=Sharma+Family&background=EA580C&color=fff',
          isOnline: true,
          isGroup: true,
          isChannel: false,
          isPinned: false,
      ...
      channels: [
        {
          ...
          lastMessage: 'New startup funding announced in Bangalore',
          timestamp: '1h ago',
          unreadCount: 12,
